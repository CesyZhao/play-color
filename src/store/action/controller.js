import { UPDATE_PLAYING_SONG, UPDATE_PLAYING_ALBUM, NEXT_SONG, PREV_SONG, UPDATE_PLAYING_MODE, UPDATE_HEARTBEAT_ALBUM, UPDATE_PLAYING_STATUS, UPDATE_VOLUME } from './actions'
